...
#define kDefaultBadgeAlignment KIBadgeViewAlignmentTopRight

@interface KIBadgeView()
...
- (id)initWithParentView:(UIView *)parentView alignment:(KIBadgeViewAlignment)alignment
{
...
{    
    ...
    switch (self.badgeAlignment) {
        case KIBadgeViewAlignmentTopLeft:
            newFrame.origin.x = -viewWidth / 2.0f;
            newFrame.origin.y = -viewHeight / 2.0f;
            break;
        case KIBadgeViewAlignmentTopRight:
//            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f);
//            newFrame.origin.y = -viewHeight / 2.0f;
            newFrame.origin.x = superviewWidth - viewWidth;
            newFrame.origin.y = 0;
            break;
        case KIBadgeViewAlignmentTopCenter:
            newFrame.origin.x = (superviewWidth - viewWidth) / 2.0f;
            newFrame.origin.y = -viewHeight / 2.0f;
            break;
        case KIBadgeViewAlignmentCenterLeft:
            newFrame.origin.x = -viewWidth / 2.0f;
            newFrame.origin.y = (superviewHeight - viewHeight) / 2.0f;
            break;
        case KIBadgeViewAlignmentCenterRight:
            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f);
            newFrame.origin.y = (superviewHeight - viewHeight) / 2.0f;
            break;
        case KIBadgeViewAlignmentBottomLeft:
            newFrame.origin.x = -textWidth / 2.0f;
            newFrame.origin.y = superviewHeight - (viewHeight / 2.0f);            break;
        case KIBadgeViewAlignmentBottomRight:
            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f);
            newFrame.origin.y = superviewHeight - (viewHeight / 2.0f);
            break;
        case KIBadgeViewAlignmentBottomCenter:
            newFrame.origin.x = (superviewWidth - viewWidth) / 2.0f;
            newFrame.origin.y = superviewHeight - (viewHeight / 2.0f);
            break;
        case KIBadgeViewAlignmentCenter:
            newFrame.origin.x = (superviewWidth - viewWidth) / 2.0f;
            newFrame.origin.y = (superviewHeight - viewHeight) / 2.0f;
            break;
        default:
...
- (void)setBadgeAlignment:(KIBadgeViewAlignment)badgeAlignment
{
