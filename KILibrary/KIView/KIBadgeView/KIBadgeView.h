...
typedef enum {
    KIBadgeViewAlignmentTopLeft,
    KIBadgeViewAlignmentTopRight,
    KIBadgeViewAlignmentTopCenter,
    KIBadgeViewAlignmentCenterLeft,
    KIBadgeViewAlignmentCenterRight,
    KIBadgeViewAlignmentBottomLeft,
    KIBadgeViewAlignmentBottomRight,
    KIBadgeViewAlignmentBottomCenter,
    KIBadgeViewAlignmentCenter
} KIBadgeViewAlignment;

@interface KIBadgeView : UIView

@property (nonatomic, copy) NSString *badgeText;

#pragma mark - Customization

@property (nonatomic, assign) KIBadgeViewAlignment badgeAlignment;
