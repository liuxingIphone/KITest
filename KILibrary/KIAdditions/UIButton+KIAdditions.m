...
- (void)setContentPadding:(CGFloat)padding aligmentVertical:(BOOL)aligmentVertical{
    ...
    if (aligmentVertical) {
        //垂直方向空白高度
        CGFloat spaceHeight = CGRectGetHeight(self.frame) - CGRectGetHeight(self.imageView.frame) - CGRectGetHeight(self.titleLabel.frame);
        ...
        CGPoint endImageViewCenter = CGPointMake(buttonBoundsCenter.x, CGRectGetMidY(self.imageView.bounds)-offestY);
        // 找出titleLabel最终的center
        CGPoint endTitleLabelCenter = CGPointMake(buttonBoundsCenter.x, CGRectGetHeight(self.bounds)-CGRectGetMidY(self.titleLabel.bounds) + offestY);
        ...
        //垂直方向空白高度
        CGFloat spaceHeight = CGRectGetWidth(self.frame) - CGRectGetWidth(self.imageView.frame) - CGRectGetWidth(self.titleLabel.frame);
        ...
        CGPoint buttonBoundsCenter = CGPointMake(CGRectGetMidX(self.bounds), CGRectGetMidY(self.bounds));
        // 找出imageView最终的center
        CGPoint endImageViewCenter = CGPointMake(CGRectGetMidX(self.imageView.bounds)-offestX, buttonBoundsCenter.y);
        // 找出titleLabel最终的center
        CGPoint endTitleLabelCenter = CGPointMake(CGRectGetWidth(self.bounds)-CGRectGetMidX(self.titleLabel.bounds)+offestX, buttonBoundsCenter.y);
