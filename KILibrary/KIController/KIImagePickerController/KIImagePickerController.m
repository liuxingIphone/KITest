    ...
    if (_actionSheet == nil) {
        ...
        _actionSheet = [[UIActionSheet alloc] initWithTitle:self.title
                                     ...
                                     destructiveButtonTitle:nil
                                          otherButtonTitles:KILocalization(@"从相册选择"), KILocalization(@"从相机拍摄"), nil];
        NSUInteger cancelIndex = 1;
        if (self.showDelete) {
            [_actionSheet addButtonWithTitle:KILocalization(@"删除图片")];
            cancelIndex++;
        }
        ...
        [_actionSheet addButtonWithTitle:KILocalization(@"取消")];
        cancelIndex++;
